...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/my-list' | '/profile' | '/feedback' | '/contact' | '/privacy-policy' | '/watch/$movieId'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/my-list' | '/profile' | '/feedback' | '/contact' | '/privacy-policy' | '/watch/$movieId'
  id: '__root__' | '/' | '/my-list' | '/profile' | '/feedback' | '/contact' | '/privacy-policy' | '/watch/$movieId'
